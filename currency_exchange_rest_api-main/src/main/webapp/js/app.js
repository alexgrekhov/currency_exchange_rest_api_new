$(document).ready(function () {
    const host = "http://localhost:8080/currency_exchange_rest_api_war"
    ...
    $("#add-exchange-rate").submit(function (e) {
        ...
        if (baseCurrency === targetCurrency) {
            const toast = $('#api-error-toast');
            toast.find('.toast-body').text("Base currency and target currency must be different");
            toast.toast("show");
            return false;
        }
